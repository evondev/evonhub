...
export function DetailsPageLayout({ children }: DetailsPageLayoutProps) {
  ...
  return (
    <div
      className={cn(
        "flex flex-col lg:grid overflow-hidden lg:overflow-visible h-[calc(100svh-172px)] sm:h-auto grid-cols-1 lg:grid-cols-[minmax(0,2fr),minmax(0,400px)] gap-0 lg:gap-8 items-start transition-all relative -mx-5 -mb-7 lg:mb-0 lg:mx-0",
